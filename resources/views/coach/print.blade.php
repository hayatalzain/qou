...
<div class="row" style="margin-top: 25px;">
    <div class="container">
        ...
        <div class="col-md-10" style="margin-top: 14px;">
            ...
            <div class="col-md-6 col-xs-6">
                <p> <span>السيد/ة :  </span> {{$items->name}}  </p>
            </div>

            <div class="col-md-6 col-xs-6">
                <p> المؤهل العلمي :<span>   </span> {{$items->coachRelation->name}} </p>
            </div>
        </div>
        <div class="col-md-10" style="margin-top: 14px;">

            <div class="col-md-6 col-xs-6">
                <p><span> رقم الهوية:  </span>{{$items->id_number}} </p>
            </div>

            <div class="col-md-6 col-xs-6">
                <p><span> رقم الجوال :</span> {{$items->mobile}} </p>
            </div>
        </div>
        <div class="col-md-10" style="margin-top: 14px;">

            <div class="col-md-6 col-xs-6">
                <p><span> البريد الاكتروني:  </span>{{$items->email}} </p>
            </div>

            <div class="col-md-6 col-xs-6">
                <p><span>  العنوان :</span> {{$items->address}} </p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="container">
            <ul class="text-right">
                ...
                <li> الرسوم المسددة (.....)دينار</li>
                <li> اجر الطرف التاني (المدرب) .... دينار </li>
                <li> مصاريف الدورة من الطرف الاول (....) دينار </li>
                <li> صافي دخل الدورة للطرف الاول (....) دينار </li>
            </ul>
        </div>
    ...
    <div class="row">
        <div class="container">
            <div class="col-md-6 col-xs-6">
                <p>المسؤول : أ. ريم البطش</p>
            </div>
            <div class="col-md-6 col-xs-6">
                <p>الطرف الثاني : {{$items->name}} </p>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        window.print();
        setTimeout(function(){
            document.location =("{{ route('coach.index') }}");
        }, 500);
    });

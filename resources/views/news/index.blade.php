    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <h4 class="header-title m-t-0 m-b-30">اعلانات</h4>
                <a href="{{route('news.create')}}" class="btn btn-success btn-bordred waves-effect w-md waves-light m-b-5" type="button">
                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tr id="row_coach{{$item->id}}">
                        ...
                        <td>
                            ...
                            <a href="{{ route("news.edit", ["id" => $item->id]) }}" class="btn btn-xs btn-icon waves-effect waves-light btn-warning m-b-5 ">
...
@section("script")
    ...
    <script>
        $(".delete").click(function(event){
            ...
            $.get('{{route('news.destroy.new')}}',{id:$id_coach},function(data){

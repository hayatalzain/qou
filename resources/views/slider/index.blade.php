    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="header-title m-t-0 m-b-30">شرائح العرض</h4>
                <a href="{{route('slider.create')}}" class="btn btn-success btn-bordred waves-effect w-md waves-light m-b-5" type="button">
               <i class="fa fa-user-plus" style="
    margin-left: 6px;
"></i>اضافة شريحة جديدة</a>
                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tr id="row_coach{{$item->id}}">
                        ...
                        <td>
                            ...
                            <a href="{{ route("slider.edit", ["id" => $item->id]) }}" class="btn btn-xs btn-icon waves-effect waves-light btn-warning m-b-5 ">
...
@section("script")
    ...
    <script>
        $(".delete").click(function(event){
            ...
            $.get('{{route('slider.destroy.new')}}',{id:$id_coach},function(data){

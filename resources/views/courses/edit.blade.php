        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card-box col-md-12">
                    ...
                    <h4 class="header-title m-t-0 m-b-30">تعديل الدورات التدريبة</h4>
                    <form action="{{route('courses.update',$items->id)}}" method="post" data-parsley-validate novalidate>
                        {{csrf_field()}}
                        @method("put")
                        ...
                        <div class="form-group col-md-9">
                            ...
                            <div class="input-group">
                                <input id="datepicker" value="{{ $items->start_course}}" data-date-format="Y-m-d" name="start_course" type="text" placeholder="ادخل تاريخ بداية الدورة"
                                       class="form-control">
                        ...
                        <div class="form-group col-md-9">
                            <label> تاريخ بداية الدورة :</label>
                            <div class="input-group">
                                <input id="datepicker" value="{{$items->end_course}}" data-date-format="Y-m-d" name="end_course" type="text" placeholder="ادخل تاريخ بداية الدورة"
                                       class="form-control">
                                <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-9">
                            ...
                            <div class="input-group m-b-15">
                                <div class="bootstrap-timepicker">
                                    <input id="timepicker" value="{{$items->time}}"  placeholder="ادخل عدد الساعات الدورة" name="time" type="text" class="form-control">
                                </div>

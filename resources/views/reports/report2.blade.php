...
<div class="">
    <div class="container">
        <p>أرفق لحضرتكم بيانات انتهاء دورة  <input type="text" style="width: 30%;"> , آملين منكم الموافقة على استصدار الشهادة الخاصة بالمشاركين وصرف مستحقات للمدرب </p>
        <table class="table table-bordered">
            <tbody>
            <tr>
                <td>عدد الطلاب</td>
                <td><input> طالب </td>
                <td>عدد المشاركين بالدورة</td>
                <td ><input></td>
            </tr>
            <tr>
                <td>اسم المدرب</td>
            ...
            <tr>
                <td>صافي الايرادات بعد خصم الاحتياجات </td>
                <td colspan="4"><input> دينار اردني فقط لا غير </td>
            </tr>
